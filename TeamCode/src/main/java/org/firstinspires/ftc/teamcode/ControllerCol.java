...
public class ControllerCol extends LinearOpMode
{
    ...
    public void runOpMode()
    {
       ...
       //   back_right_motor.setPower(back_right_power);
            ...
            if (B) {
                ...
                worm_gear.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);
                turnage2 = (worm_gear.getCurrentPosition()+85 + 1.5*2)*-2;
            ...
            telemetry.addData("wormpose:", worm_gear.getCurrentPosition());
            telemetry.update();
        }
    }
